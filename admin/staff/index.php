...
$dbIO = new DatabaseIO();
$count = $dbIO->get_count(TBL_STAFF);

$dbIO = new DatabaseIO();
$present = $dbIO->get_entry(TBL_ATTEND , "COUNT(ID)" , "Date" , $day);
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-users"></span>  Staff  Details</div>
                    <div class="panel-body">
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-lg-4" >
                                    <div class="box blue">
                                        <h6>Today's Attendance %age</h6>
                                        <h1><?php echo $count != 0 ?  ($present/$count)*100:0 ;?>%</h1>
                                    </div>
                                </div>
                            </div>
                        </div>
