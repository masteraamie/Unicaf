...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    try {
        ...
        if ($barcode != "") {
            $errors = $validate->validate_barcode($barcode, $quantity, $amount, $paid, $sup_id, $sup_name);

            if (empty($errors)) {
                if ($upload->add_stock_barcode($barcode, $quantity, $amount, $paid, $sup_id, $sup_name) == 1) {
            ...
            $errors = $validate->validate_stock($id, $quantity, $amount, $paid, $sup_id, $sup_name);

            if (empty($errors)) {
                if ($upload->add_stock_id($id, $quantity, $amount, $paid, $sup_id, $sup_name) == 1) {
                    echo "<script>alert('Stock Uploaded Successfully');</script>";
                } else {
                    echo "<script>alert('Stock Upload Failed');</script>";
                }
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="text-align: center">
                        <div class="btn-group btn-group-sm">
                            <a href="add_stock.php" class="btn btn-primary"><span class="fa fa-plus"></span> Add Stock</a>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-plus-circle"></span> Add Stock</div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <?php }
                                                    ...
                                                    echo "<br><h4 style='text-align: center;'><label class='label label-danger'>No Products Added</label></h4><br/><br/>";
                                                ?>
                                            </div>
                                            <div class="col-lg-12">
                                                <label>Quantity</label>
                                                <input type="text" name="qnty" value="<?php echo $quantity; ?>" class="form-control" placeholder="e.g. 10">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="amt" value="<?php echo $amount; ?>" class="form-control" placeholder="e.g. 10">
                                            </div>
                                            <div class="col-lg-12">
                                                <label>Paid (in rupees)</label>
                                                <input type="text" name="paid" value="<?php echo $paid; ?>" class="form-control" placeholder="e.g. 10">
                                            </div>
                                            <div class="col-lg-12">
                                                <input type="submit" name="submit" value="Add Stock" class="btn btn-success pull-right">
                                            </div>
                                        </div>
                                    </div>
        ...
        $("#mainform").validate({
            ...
            messages: {
                paid : {
                    ...
                    maxlength: "Paid mount can only contain 10 digits"
                },
                amt : {
