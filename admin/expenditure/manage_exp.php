...
$ID = $Name = $Quantity = $Balance = array();

$query = "SELECT ID , Name , Quantity , Balance  FROM " . TBL_EXPENDITURE . " ORDER BY Name ASC";

$ID = $Name = "";
$connection2 = new mysqli(HOST , USER , PASSWORD , DB_NAME);
$command2 = $connection2->prepare($query);
$command2->execute();
$command2->bind_result($i , $n , $q , $b);
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-hand-pointer-o"></span> Manage Expenditure</div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table" id="data">
                                                ...
                                                for($i = 0 ; $i < count($ID) ; $i++)
                                                {
                                                        ...
                                                        echo "<a href='edit_exp.php?ID=$ID[$i]' class='btn btn-primary btn-xs'>Edit</a>";
                                            ...
                                            {
                                                echo "<h2 style='text-align: center;'>You Have No Expenditures Added</h2>";
                                            }
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#exportexcel").click(function(){
            ...
            window.location.href = "manage_exp.php";
        });
    });
