...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if($name != "" && $serial != "")
    {
            ...
            {
                $dbIO = new DatabaseIO();
                $dep = $dbIO->get_entry(TBL_DEPARTMENT , "Name" , "Serial" , $serial);
                if (!empty($dep))
                    $errors['serial'] = "Department with this Serial Already Present in Database ";
        ...
        if(empty($errors)) {
            $upload = new Upload();
            if ($upload->add_department($name, $serial) == 1) {
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="text-align: center">
                        <div class="btn-group btn-group-sm">
                            <a href="add_dep.php" class="btn btn-primary"><span class="fa fa-plus"></span> Add Department</a>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-plus-circle"></span> Add Department</div>
                            ...
                            <div class="row">
                                ...
                                <form id="mainform" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <input type="submit" name="submit" value="Add Department" class="btn btn-success pull-right">
                                        </div>
        ...
        $("#mainform").validate({
            ...
            messages: {
                ...
                serial : {
                    ...
                    maxlength: "Serial cannot be longer than 40 characters"
                }
            }
        });
