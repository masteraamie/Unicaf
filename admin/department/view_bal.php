...
$ID = $Name = $Total = $Paid = $Balance = array();

$query = "SELECT ID , deptName , Total , Paid , Balance  FROM " . TBL_DEPT_BILLS . " WHERE (Month = ? and Year = ?) ORDER BY deptName ASC";

$connection2 = new mysqli(HOST , USER , PASSWORD , DB_NAME);
$command2 = $connection2->prepare($query);
$command2->bind_param("ii" , $month , $year);
$command2->execute();
$command2->bind_result($i , $n , $t , $p , $b);
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="text-align: center">
                        ...
                        <div class="btn-group btn-group-sm">
                            ...
                            <a href="view_bal.php" class="btn btn-primary"><span class="fa fa-table"></span> View Balance</a>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-table"></span> View Balance</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="table-responsive">
                                        ...
                                        {
                                            echo "<h2 style='text-align: center;'>You Have No Balance Records</h2>";
                                        }
