...
if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['ID']))
{
    ...
    if($id != "" &&  is_numeric($id))
    {
        $query = "SELECT Name from ".TBL_SUPPLIER." WHERE (ID = ?)";
    ...
    header("Location:manage_supp.php");
...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    if(!$validate->validate_empty($name))
    {
        ...
        if ($update->update_supplier($name , $id) == 1) {
            echo "<script>alert('Supplier Updated Successfully');</script>";
            echo "<script>window.location='manage_supp.php';</script>";
        } else {
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-edit"></span> Edit Supplier</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="name" value="<?php echo $name;?>" class="form-control" placeholder="e.g. 10">
                                            </div>
                                            <div class="col-lg-12">
