...
if($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['ID']))
{
    ...
    if($id != "" &&  is_numeric($id))
    {
        $query = "SELECT `Name`, `Quantity` , `Value` from ".TBL_PROPERTY." WHERE ID = ?";
        $connection = new mysqli(HOST , USER , PASSWORD , DB_NAME);
        $statement = $connection->prepare($query);
        $statement->bind_param("i" , $id);
        $statement->execute();
        $statement->bind_result($name ,  $quantity , $value);
...
if($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
    ...
    {
        $upload = new Update();
        if($upload->update_property($name , $quantity , $value , $id) == 1)
        {
            echo "<script>alert('Property Item Updated Successfully');</script>";
            echo "<script>window.location = 'manage_prop.php';</script>";
        }
        else
        {
            echo "<script>alert('Error Updating Property Item');</script>";
        }
    }
    else
    {
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body" style="text-align: center">
                        <div class="btn-group btn-group-sm">
                            <a href="add_prop.php" class="btn btn-default"><span class="fa fa-plus"></span> Add Property</a>
                            <a href="manage_prop.php" class="btn btn-primary"><span class="fa fa-hand-pointer-o"></span> Manage Property</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-edit"></span> Edit Property</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="propname" value="<?php echo $name; ?>" class="form-control" placeholder="e.g. Sofa Set">
                                            </div>

                                            <div class="col-lg-12">
                                                <label>Quantity</label>
                                                <input placeholder="e.g.10" type="text" value="<?php echo $quantity; ?>" name="qnty" class="form-control">
                                            </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <input type="text" name="propvalue" value="<?php echo $value; ?>" placeholder="e.g. 10000" class="form-control">
                                            </div>
