...
$query = "SELECT ID , Name , Quantity , Value FROM " . TBL_PROPERTY . " ORDER BY Name ASC";

$ID = $Name = $Quantity  = $Value = array();
$connection2 = new mysqli(HOST , USER , PASSWORD , DB_NAME);
$command2 = $connection2->prepare($query);
$command2->execute();
$command2->bind_result($i , $n , $q , $v);
    ...
    <div class="container-fluid" style="padding-top: 50px">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading"><span class="fa fa-hand-pointer-o"></span> Manage Property</div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="data">
                                            ...
                                            for($i = 0 ; $i < count($Name) ; $i++)
                                            {
                                                ...
                                                echo "<a href='edit_prop.php?ID=$ID[$i]' class='btn btn-primary btn-xs'>Edit</a>";
                                        ...
                                        {
                                            echo "<h2 style='text-align: center;'>You Have No Property Items Added</h2>";
                                        }
...
<script>
    ...
    $(document).ready(function(){
        ...
        $("#exportexcel").click(function(){
            ...
            window.location.href = "manage_prop.php";
        });
